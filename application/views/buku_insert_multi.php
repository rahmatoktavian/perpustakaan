<form method="post" action="<?php echo site_url('buku/insert_submit_multi/');?>" enctype="multipart/form-data">
	<table class="table table-striped">
		...
		<tr>
			...
			<td>
				<!--input untuk memilih file yang akan diupload-->
				<input type="file" name="cover2" size="20" class="form-control-file" />
			</td>
		</tr>
		<tr>
			<td>Judul</td>
